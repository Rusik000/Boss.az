...
namespace BOSSAZ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                JsonFileHelper.Deserialization(ref database);
                UniqueStaticID.id = database.DatabaseCurrentID;
            }
            else
            ...
            while (true)
            {
                ...
                if (choice == BossFirstMenuChoices.Exit)
                {
                    ...
                    JsonFileHelper.Serialization(database);
                    break;
                }
                ...
                if (choice == BossFirstMenuChoices.Employer)
                {
                    while (true)
                    {
                        ...
                        {
                            Console.WriteLine("\nUsername exists or empty, Enter again: ");
                        ...
                        if (!isConfirmedEmployer)
                            MessageBox.Show("Wrong Input", "Boss.az", MessageBoxButtons.OK);
                        else
                        {
                            Console.Clear();
